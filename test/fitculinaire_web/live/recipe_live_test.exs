defmodule FitculinaireWeb.RecipeLiveTest do
  use FitculinaireWeb.ConnCase

  import Phoenix.LiveViewTest
  import Fitculinaire.RecipesFixtures

  @create_attrs %{cooking_time: "some cooking_time", description: "some description", instruction: "some instruction", is_private: true, notes: "some notes", preparation_time: "some preparation_time", title: "some title"}
  ...
  @invalid_attrs %{cooking_time: nil, description: nil, instruction: nil, is_private: false, notes: nil, preparation_time: nil, title: nil}
  ...
  describe "Index" do
    ...
    test "lists all recipes", %{conn: conn, recipe: recipe} do
      ...
      assert html =~ recipe.cooking_time
    end
    ...
    test "updates recipe in listing", %{conn: conn, recipe: recipe} do
      ...
      assert html =~ "some updated cooking_time"
    end
