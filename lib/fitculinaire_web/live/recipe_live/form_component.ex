defmodule FitculinaireWeb.RecipeLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:instruction]} type="text" label="Instruction" />
        <.input field={@form[:cooking_time]} type="text" label="Cooking time" />
        <.input field={@form[:preparation_time]} type="text" label="Preparation time" />
