defmodule FitculinaireWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FitculinaireWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FitculinaireWeb.Gettext, "errors", msg, opts)
    end
  end
